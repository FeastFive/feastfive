...
export default function RestaurantCharts() {
  ...
  return (
    <div>
      <h3 className="text-4xl font-semibold text-center my-2 py-8 flex flex-col"> Statistics</h3>
      <div className="flex flex-row flex-wrap justify-center place-items-center gap-6   lg:px-4">
        <div className="w-[480px] sm:w-[600px] lg:w-[29%] flex justify-center">
    ...
    <div className="flex flex-row flex-wrap justify-center gap-6 pt-12 py-24">
      ...
      <div className="bg-cyan-300 bg-opacity-40 w-[600px] lg:w-[470px] h-[200px] rounded-md shadow-md px-12 py-12">
