          ...
          {cart.cartFoodList.length > 0 ? (
            <div className="overflow-y-scroll  pr-10">
              {cart.cartFoodList.map((food, _index) => (
                <div key={_index} className="h-auto  pt-2 pb-4 ">
                  <div className="flex flex-row ">
                    ...
                    <h3 className="text-lg font-semibold pb-1  border-b-[2px] border-gray-400 w-auto pl-2 pr-5 ">
                      {food.foodName}
                    </h3>
                  </div>
                  <div>
              ...
              <div className="absolute bottom-0 mb-2 font-semibold flex flex-row w-full pb-2 justify-between bg-[#FFFFFF] pt-3">
                ...
                <button className="bg-red-300 bg-opacity-40 rounded-md shadow-sm hover:bg-opacity-100 duration-200 py-1 w-[80%] mr-20">
                  Buy
                </button>
              </div>
            </div>
